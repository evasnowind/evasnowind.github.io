---
title: "源码分析之 Netty 线程模型"
date: "2020-09-09"
categories: ["中间件"]
tags: ["源码分析", "Netty"]
source: "http://prayerlaputa.com/?p=853"
description: "从 Reactor 模式切入，梳理 Netty 线程模型的演进思路、核心结构与设计要点。"
---

## 从 Reactor 模式说起

想理解 Netty 的线程模型，最好先从 Reactor 模式入手。这个模式通常会追溯到 Doug Lea 在 `Scalable IO in Java` 中提到的 `Multiple Reactors` 思路，先看下图：

<!-- more -->

![](/images/multiple-reactors-pattern-300x234_37432a92.jpg)

如果想进一步理解 Reactor 模式出现的背景，可以顺着 I/O 模型的演进过程往前看。这里不再展开，感兴趣的话可以参考这篇文章：[Reactor模式](https://www.cnblogs.com/crazymakercircle/p/9833847.html)。
...
>
> ![](/images/reactor-class-diagram-300x194_f846bdac.jpg)
>
...
> Reactor时序图 如下：
>
> ![](/images/reactor-sequence-diagram-300x174_505192ef.jpg)
>
...
![](/images/netty-io-thread-model-300x149_741ed623.png)
...
学习如何使用Netty，最典型、最权威的当属Netty自己提供的范例，我们可以在Netty源码中找到这些例子，参见<https://github.com/netty/netty>项目中的example文件夹。
