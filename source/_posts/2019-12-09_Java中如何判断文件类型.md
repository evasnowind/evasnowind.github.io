---
title: "Java 中如何判断文件类型"
date: "2019-12-09"
categories: ["Java"]
tags: ["Java"]
source: "http://prayerlaputa.com/?p=727"
description: "整理 Java 中根据文件后缀和文件魔数判断文件类型的两种常见方式，以及各自的适用场景。"
---

在 Java 里判断文件类型，常见做法主要有两种：一种看文件名或后缀，另一种直接读取文件内容判断。
