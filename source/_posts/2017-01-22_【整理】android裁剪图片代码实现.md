...
description: "android系统中已经存在一个用于裁剪图片的控件，基本参数如下（取自：Android中com.android.camera.action.CROP（图片裁剪）所有属性）："
---
...
MediaStore.EXTRA\_OUTPUT（"output"）URI 将 URI 指向相应的文件路径（file URI），\
