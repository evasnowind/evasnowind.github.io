---
title: "分布式一致性与共识之（一）Raft"
date: "2020-10-22"
categories: ["架构"]
tags: ["分布式"]
source: "http://prayerlaputa.com/?p=899"
description: "在raft中，服务器节点共有3种状态（或者说角色）：。"
---
...
![](/images/raft-state-change-300x125_54bf77b5.png)
...
![](/images/replicated-state-machine_0a99b804.jpg)

![](/images/replicated-state-machine2_df26b508.jpg)
...
![](/images/raft-split-vote_d07719fd.png)
...
![](/images/raft-network-partition_e0456c40.png)

此时若有client去更新数据，如果分区内能够达到整个集群的多数，就能commit成功，但可能出现以给一个分区提交成功、另外一个分区的节点无感知。 如

![](/images/raft-network-partition-modify-value_4d7cf158.png)

故障恢复时，重新接入的分区会比较election term，比较高版本的leader的日志，使得自身的版本与新版本一致

![](/images/raft-network-partition-heal_ffa350ee.png)
...
>
> 参考 [Raft一致性算法](https://blog.csdn.net/cszhouwei/article/details/38374603) [Raft 一致性算法论文译文](http://www.infoq.com/cn/articles/raft-paper)
