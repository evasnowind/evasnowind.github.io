...
description: "记录在 Linux 虚拟机中安装 VMware Tools 的基本步骤。"
---
...
- 在 弹出的对话框里选择“CD-Rom”，在右边的框中选择“Use ISO image”，并设置其值，在VMware的安装路径下，如D:\Program Files\VMware\VMware Workstation\linux.iso。（根据你安装的虚拟系统，选择不同的image，这些是VMWare自带的。）
