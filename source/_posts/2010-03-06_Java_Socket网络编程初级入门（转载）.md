...
原文链接：http://www.wang48.com/jishubaodianview/?jsd\_id=4902
（转到自己博客，省的到处去翻）
...
上面两句就是建立缓冲并把原始的字节流转变为 Unicode可以操作，而原始的字节流来源于Socket的两个方法，getInputStream()和getOutputStream()方，分别用来得到输入和输出，那么现在有了基本的模型和基本的操作工具，我们可以做一个简单的Socket例程了.
服务方:
import java.io.\*;
import java.net.\*;
