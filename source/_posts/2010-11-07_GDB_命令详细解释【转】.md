...
categories: ["C/C++"]
tags: ["C/C++"]
source: "http://prayerlaputa.com/?p=409"
description: "GDB 命令详细解释 Linux中包含有一个很有用的调试工具－－gdb(GNU Debuger)，它可以用来调试C和C++程序，功能不亚于Windows下的许多图形界面的调试工具。"
---

### [（转）GDB 命令详细解释](http://mlxia.javaeye.com.sixxs.org/blog/600784)

**文章分类:[JavaEye](http://www.javaeye.com.sixxs.org/blogs/category/javaeye)**
...
本文来自CSDN博客，转载请标明出处：http://blog.csdn.net.sixxs.org/wei801004/archive/2009/06/09/4253911.aspx