---
title: "如何部署activemq以及部署时遇到的相关问题"
date: "2021-01-11"
categories: ["中间件"]
tags: ["ActiveMQ"]
source: "http://prayerlaputa.com/?p=926"
description: "以centos为例，下载jar包，tar -zxvf xxx解压后，进入activemq解压文件夹，执行./bin/activemq console即可在shell前端启动，想。"
---
