---
title: "linux批量删除多个文件，正则匹配删除文件"
date: "2020-02-18"
categories: ["Linux"]
tags: ["Linux"]
source: "http://prayerlaputa.com/?p=758"
description: "首先查找要删除的某类批量的文件： find. -maxdepth 1 -regex \".ws.\" maxdepth参数为1表示只在当前目录查找，不递归查找子目录 regex参数。"
---
